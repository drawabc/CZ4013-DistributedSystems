...
import main.client.InsertToFile;
import main.client.ReadFile;
import main.client.Utils;
...
public class TestMarshal {
    public static void main(String args[]) {
        ...
        // HandleReadFile.handleRequest(ReadFile.promptUser(sc));
        HandleInsertToFile.handleRequest(InsertToFile.promptUser(sc));
    }
}